...
function SidebarProvider({
  ...
  const state: SidebarContextValue["state"] = isExpanded ? "expanded" : "collapsed"
...
type SidebarProps = SidebarOwnProps &
  Omit<React.HTMLAttributes<HTMLDivElement>, keyof SidebarOwnProps>
  ...
  if (isMobile) {
    return (
      <Sheet
        ...
        {...(props as React.ComponentPropsWithoutRef<typeof Sheet>)}>
        <SheetContent
...
function SidebarMenuButton({
  ...
  const tooltipContentProps: React.ComponentPropsWithoutRef<typeof TooltipContent> =
