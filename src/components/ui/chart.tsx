...
type ChartPayloadItem = {
  ...
  value?: string | number
  color?: string
  payload?: Record<string, string | number | undefined> & { fill?: string }
}

type ChartFormatterArgs = [
  value: string | number,
  name: string | number,
...
type ChartTooltipContentProps = {
  ...
  formatter?: (...args: ChartFormatterArgs) => React.ReactNode
  color?: string
  nameKey?: string
  labelKey?: string
}
...
function getPayloadConfigFromPayload(
  config: ChartConfig,
  payload: ChartPayloadItem | LegendPayloadItem,
  key: string
) {
  ...
  if (
    key in payload &&
    typeof (payload as Record<string, string | undefined>)[key] === "string"
  ) {
