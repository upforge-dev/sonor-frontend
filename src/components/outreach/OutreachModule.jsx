...
const LeadSourcesTab = lazy(() => import('./tabs/LeadSourcesTab'))
const OnboardingTab = lazy(() => import('./tabs/OnboardingTab'))
...
const SIDEBAR_SECTIONS = [
  ...
  },
  {
    ...
    requiresSignal: true,
    items: [
      { value: 'outreach-onboarding', label: 'Get Started', icon: Trophy },
      ...
      { value: 'lead-sources', label: 'Lead Sources', icon: Upload },
...
export default function OutreachModule() {
  ...
  const renderContent = () => {
    ...
    if (activeTab === 'outreach-onboarding') return <Suspense fallback={lazyFallback}><OnboardingTab /></Suspense>
    ...
    if (activeTab === 'leads') return <Suspense fallback={lazyFallback}><LeadsTab /></Suspense>
    if (activeTab === 'lead-sources') return <Suspense fallback={lazyFallback}><LeadSourcesTab /></Suspense>
